...
Full details: [ML & AI Experience](ml-projects/ML_AI_Experience.md)
...
- **Daily Breakout:** -$463K to +$603K (+$1.06M improvement)
...
1. **Analysis Phase**
   - Deep dive into existing strategy performance
   - Identify specific failure patterns
   - Compare winning vs losing trade characteristics

2. **Hypothesis Phase**
   - Develop theories on performance issues
   - Design targeted parameter adjustments
   - Create optimization testing framework
...
## Case Study: Daily Breakout Transformation
...
**Contact:** [pythology@outlook.com](mailto:pythology@outlook.com)
...
- Email: [pythology@outlook.com](mailto:pythology@outlook.com)
- GitHub: [PythologyNZ](https://github.com/PythologyNZ)

---

&copy; 2026 Pythology. All Rights Reserved.
*The Science of Algorithmic Trading*
